...
def test_fetch_live_price_validation(monkeypatch, payload, expected_error):
    ...
    monkeypatch.setattr("reference_bot.market.requests.get", Mock(return_value=response))
...
def test_fetch_live_price_success(monkeypatch):
    ...
    monkeypatch.setattr("reference_bot.market.requests.get", get)
...
def test_mexc_rest_price_candles_and_reverse(monkeypatch):
    ...
    monkeypatch.setattr("reference_bot.market.requests.get", Mock(return_value=price_response))
